...
export class BoardService {
  public decor(gridColor: string | number): Group {
    ...
    const gridHelper = new THREE.GridHelper(0.1, 10, gridColor, gridColor);
    gridHelper.position.y = cm(0.045);
    decorGroup.add(gridHelper);

    // Create a box geometry and material
    const playerGeometry = new THREE.BoxGeometry(cm(8), cm(0.05), cm(0.25));
